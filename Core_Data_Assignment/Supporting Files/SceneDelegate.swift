...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // Initialize the ViewController with ViewModel
        let homepageViewController = HomepageViewController(viewModel: viewModel)
        ...
        // Assign the window to the AppDelegate's window property
        self.window = window
    }
